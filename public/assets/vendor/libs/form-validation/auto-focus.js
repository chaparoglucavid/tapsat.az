    ...
    return function () {
        ...
        var e = {
            1979: function (e, t) {
                var i = {
                    ...
                    function e(e, t) {
                        this.fields = {}, this.elements = {}, this.ee = {
                            ...
                            filters: {}, add: function (e, t) {
                                ...
                                for (var n = t, r = this.filters[e], o = r.length, s = 0; s < o; s++) n = r[s].apply(n, i);
                                return n
                            }, remove: function (e, t) {
                    ...
                    return e.prototype.on = function (e, t) {
                        ...
                        return this.waterfall(o).then((function (r) {
                            ...
                            return "radio" !== s && "checkbox" !== s && 1 !== n.length || i.emit(o ? "core.field.valid" : "core.field.invalid", e), Promise.resolve(o ? "Valid" : "Invalid")
                        })).catch((function (r) {
                        ...
                        var r = this, o = this.elements[e], s = this.filter.execute("validator-name", i, [i, e]);
                        if (n.message = this.filter.execute("validator-message", n.message, [this.locale, e, s]), !this.validators[s] || !1 === n.enabled) return this.emit("core.validator.validated", {
                            element: t,
                            elements: o,
                            field: e,
                        ...
                        var l = this.validators[s], a = this.getElementValue(e, t, s);
                        if (!this.filter.execute("field-should-validate", !0, [e, t, a, i])) return this.emit("core.validator.notvalidated", {
                            element: t,
                            elements: o,
                            field: e,
                            validator: i
                        ...
                        var r = this, o = this.elements[e], s = this.fields[e].validators, l = n ? [n] : Object.keys(s);
                        switch (i) {
                            case"NotValidated":
                    ...
                    call: function (e, t) {
                        ...
                        if ("string" == typeof e) {
                            ...
                            for (var n = i.split("."), r = n.pop(), o = window, s = 0, l = n; s < l.length; s++) o = o[l[s]];
                        ...
                        return new Promise((function (i, n) {
                            var r, o = Object.assign({}, {crossDomain: !1, headers: {}, method: "GET", params: {}}, t),
                                s = Object.keys(o.params).map((function (e) {
                                    return "".concat(encodeURIComponent(e), "=").concat(encodeURIComponent(o.params[e]))
                                })).join("&"), l = e.indexOf("?") > -1,
                                a = "GET" === o.method ? "".concat(e).concat(l ? "&" : "?").concat(s) : e;
                            if (o.crossDomain) {
                                ...
                                window[u] = function (e) {
                                    delete window[u], i(e)
                                }, d.src = "".concat(a).concat(l ? "&" : "?", "callback=").concat(u), d.async = !0, d.addEventListener("load", (function () {
                                ...
                                c.open(o.method, a), c.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "POST" === o.method && c.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), Object.keys(o.headers).forEach((function (e) {
                                    return c.setRequestHeader(e, o.headers[e])
                                })), c.addEventListener("load", (function () {
                                    i(JSON.parse(this.responseText))
                                })), c.addEventListener("error", (function () {
                                    return n
                                })), c.send((r = o.params, Object.keys(r).map((function (e) {
                        ...
                        if (!0 === n) {
                            var r = new Date, o = r.getFullYear(), s = r.getMonth(), l = r.getDate();
                ...
                var n = i(4786), r = i(8435), o = function (e, t) {
                    ...
                    function t(t) {
                        ...
                        }, t), i.invalidFormHandler = i.onFormInvalid.bind(i), i
                    }
                    ...
                    return function (e, t) {
                        ...
                        if (this.isEnabled) {
                            ...
                            if (i.length > 0) {
                                var n = i[0], r = this.core.getElements(n);
                                if (r.length > 0) {
                                    var o = r[0], s = {firstElement: o, field: n};
                                    this.core.emit("plugins.autofocus.prefocus", s), this.opts.onPrefocus(s), o.focus()
                                }
                            }
                        }
                    }, t.FIELD_STATUS_PLUGIN = "___autoFocusFieldStatus", t
                }(n.Plugin);
                t.AutoFocus = s
            }, 518: function (e, t, i) {
                e.exports = i(7478)
