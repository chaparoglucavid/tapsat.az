...
document.addEventListener("DOMContentLoaded", function (e) {
    t = document.getElementById("form-add-new-record"), setTimeout(() => {
        let e = document.querySelector(".create-new"), t = document.querySelector("#add-new-record");
    ...
    let o;
    t && ((s = document.createElement("h5")).classList.add("card-title", "mb-0", "text-md-start", "text-center"), s.innerHTML = "DataTable with Buttons", o = new DataTable(t, {
        ajax: assetsPath + "json/table-datatable.json",
        columns: [{data: "id"}, {
            data: "id",
            orderable: !1,
            render: DataTable.render.select()
        }, {data: "id"}, {data: "full_name"}, {data: "email"}, {data: "start_date"}, {data: "salary"}, {data: "status"}, {data: "id"}],
        columnDefs: [{
            className: "control",
            orderable: !1,
            searchable: !1,
            ...
            targets: 3, responsivePriority: 4, render: function (e, t, a, s) {
                var n = a.avatar, r = a.full_name, a = a.post;
                let o;
                if (n) o = `<img src="${assetsPath}img/avatars/${n}" alt="Avatar" class="rounded-circle">`; else {
                    n = ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())];
                    let e = r.match(/\b\w/g) || [];
                    e = ((e.shift() || "") + (e.pop() || "")).toUpperCase(), o = `<span class="avatar-initial rounded-circle bg-label-${n}">${e}</span>`
                }
                return `
        ...
        order: [[2, "desc"]],
        layout: {
            top2Start: {rowClass: "row card-header flex-column flex-md-row pb-0", features: [s]},
            top2End: {
                features: [{
                    buttons: [{
                        extend: "collection",
                                ...
                                columns: [3, 4, 5, 6, 7], format: {
                                    body: function (e, t, a) {
                                        ...
                                        return 0 < n.length ? n.forEach(e => {
                                            e = e.querySelector(".fw-medium")?.textContent || e.querySelector(".d-block")?.textContent || e.textContent;
                                            s += e.trim() + " "
                                        }) : s = e.body.textContent || e.body.innerText, s.trim()
                                    }
                                }
                            }
                        }, {
            ...
            topStart: {
                ...
                features: [{pageLength: {menu: [10, 25, 50, 100], text: "Show_MENU_entries"}}]
            },
        ...
        responsive: {
            details: {
                display: DataTable.Responsive.display.modal({
                    ...
                    return !!a && ((s = document.createElement("div")).classList.add("table-responsive"), n = document.createElement("table"), s.appendChild(n), n.classList.add("table"), n.classList.add("datatables-basic"), (r = document.createElement("tbody")).innerHTML = a, n.appendChild(r), s)
                }
            }
        }
    }), r = 101, fv.on("core.form.valid", function () {
    ...
    s && (n = new DataTable(s, {
        ...
        drawCallback: function (e) {
            var t = this.api();
            let n = t.rows({page: "current"}).nodes(), r = null;
            t.column(2, {page: "current"}).data().each(function (e, t) {
                var a, s;
                r !== e && ((a = document.createElement("tr")).classList.add("group"), (s = document.createElement("td")).setAttribute("colspan", "8"), s.textContent = e, a.appendChild(s), n[t].parentNode.insertBefore(a, n[t]), r = e)
            })
        },
        responsive: {
            details: {
                display: DataTable.Responsive.display.modal({
                    ...
                    return !!a && ((s = document.createElement("div")).classList.add("table-responsive"), n = document.createElement("table"), s.appendChild(n), n.classList.add("table"), (r = document.createElement("tbody")).innerHTML = a, n.appendChild(r), s)
                }
            }
        }
    }), document.addEventListener("click", function (e) {
        e.target.classList.contains("delete-record") && (n.row(e.target.closest("tr")).remove().draw(), e = document.querySelector(".dtr-bs-modal")) && e.classList.contains("show") && bootstrap.Modal.getInstance(e)?.hide()
    }));
    ...
    t && (l = new DataTable(t, {
        ...
        columnDefs: [{
            ...
            targets: -1, title: "Actions", orderable: !1, className: "", searchable: !1, render: function (e, t, a, s) {
        ...
        layout: {
            topStart: {
                ...
                features: [{pageLength: {menu: [7, 10, 25, 50, 100]}}]
            },
