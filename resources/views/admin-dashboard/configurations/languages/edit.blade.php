                        ...
                        <form method="POST" action="{{ route('languages.update', $language->uuid) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="code" value="{{ $language->code }}" class="form-control" id="defaultFormControlInput"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" value="{{ $language->name }}" class="form-control" id="defaultFormControlInput"
